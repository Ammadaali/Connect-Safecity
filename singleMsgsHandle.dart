...
class SingleMsgsHandle extends StatefulWidget {
  ...
  @override
  _SingleMsgsHandleState createState() => _SingleMsgsHandleState();
}

class _SingleMsgsHandleState extends State<SingleMsgsHandle> {
  ...
  Widget build(BuildContext context) {
    ...
    DateTime d = DateTime.parse(widget.date!.toDate().toString());
                ...
                child: Column(
                  ...
                  children: [
                    Align(
                      ...
                      child: Text(
                        widget.isMe! ? widget.myName! : widget.friendName!,
                        style: TextStyle(
                            fontSize: 15,
