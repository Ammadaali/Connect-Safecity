...
class Guardian_MyProfile extends StatefulWidget {
  @override
  _Guardian_MyProfileState createState() => _Guardian_MyProfileState();
}

class _Guardian_MyProfileState extends State<Guardian_MyProfile> {
      ...
      body: Center(
        child: Column(
          children: <Widget>[
            ...
            buildProfileItem('Your Email:', guardiantEmail),
